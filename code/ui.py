...
class UI:
    ...
    def display_text(self):
        text_surf = self.font.render(str(self.coin_amount), False, '#2f2e2b')
        text_rect = text_surf.get_frect(topleft = (40, 30))
        self.display_surface.blit(text_surf, text_rect)

        coin_rect = self.coin_surf.get_frect(topleft = (10, 38))
